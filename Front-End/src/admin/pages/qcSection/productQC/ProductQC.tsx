...
const ProductQC: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchProduct = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/product/fetchToQC");
              ...
              <div className={styles.column}>
                <div className={styles.seller_info}>
                  ...
                  <div className={styles.info_row}>
                    ...
                    <span className={styles.value}> {new Date(product.createdAt).toLocaleDateString("en-GB", {
                       year: "numeric",
                       month: "2-digit",
                       day: "2-digit",
                       hour: "2-digit",
